...
def getImgExtraInfoV2 ():
    ...
    resultColor = "{\"attr_no\":" + str(dictionary[result_batch_color]).split("_")[0] + ", \"pattern_nm\":\"" + str(dictionary[result_batch_color]).split("_")[1]+ "\", \"img_url\":\"" + str(img_url) + "\"" +  "}"
    ...
    resultPattern = "{\"attr_no\":" + str(dictionary[result_batch_pattern]).split("_")[0] + ", \"style_nm\":\"" + str(dictionary[result_batch_pattern]).split("_")[1]+ "\", \"img_url\":\"" + str(img_url) + "\"" +  "}"
