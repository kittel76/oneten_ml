...
CHECKPOINT_DIR = '/data/www/oneten/dl_img_category_process3/train_dir_for_service/'
...
def main(argv=None):  # pylint: disable=unused-argument
  ...
  first = getCategory("/tmp/img_88592.jpg")
  print("in main:",  first)
  #
  #
  # unique_labels = [l.strip() for l in tf.gfile.FastGFile('/data/www/oneten/dl_img_dl_img_color_process2/data_dir/labels.txt', 'r').readlines()]
  # dictionary = dict()
  ...
  # freeze_graph("/data/www/oneten/dl_img_category_process3/train_dir/")
  #
  # graph = load_graph("/data/www/oneten/dl_img_category_process3/train_dir/frozen_model.pb")
  #
