...
tf.app.flags.DEFINE_string('train_directory', '/data/www/oneten/dl_img_category_process3/test_data_dir/',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', '/data/www/oneten/dl_img_category_process3/test_data_dir/',
                           'Validation data directory')
tf.app.flags.DEFINE_string('output_directory', '/data/www/oneten/dl_img_category_process3/test_data_dir',
...
tf.app.flags.DEFINE_string('labels_file', '/data/www/oneten/dl_img_category_process3/test_data_dir/labels.txt', 'Labels file')
...
def _make_data(directory, labels_file, i_cate_no):
    # os.rmdir(directory)
    # os.mkdir(directory)
    ...
    cate_nms, cate_nos = dbJob.getCateNmsForTest()
    ...
    for (i, cate_no) in zip(cate_nms, cate_nos):
        ...
        img_list, file_list = dbJob.getCatePrdImgListForTest(cate_no)
...
def main(unused_argv):
  ...
  _make_data(FLAGS.validation_directory, FLAGS.labels_file, cate_no)
