...
# CHECKPOINT_DIR = '/data/www/oneten/dl_img_pattern_process2/train_dir_for_service/'
CHECKPOINT_DIR = '/data/www/oneten/dl_img_pattern_process2/train_dir_for_service/'
...
def eval(saver, images, prediction, hypothesis):
  ...
  with tf.Session() as sess:
    ...
    print("FLAGS.checkpoint_dir", CHECKPOINT_DIR)
...
def main(argv=None):  # pylint: disable=unused-argument
  ...
  #
  # first, second = getStyle("./test_tmp/래깅스.png")
  # print("in main:",  first, second)
  #
  #
  # unique_labels = [l.strip() for l in tf.gfile.FastGFile('/data/www/oneten/dl_img_style_process/data_dir/labels.txt', 'r').readlines()]
  # dictionary = dict()
