...
from img_pattern_process2 import cifar10
from db_util import log_util

FLAGS = tf.app.flags.FLAGS
BATCH_SIZE=128

tf.app.flags.DEFINE_string('eval_dir', '/data/www/oneten/dl_img_pattern_process2/eval',
                           """Directory where to write event logs.""")
tf.app.flags.DEFINE_string('eval_data', 'test',
                           """Either 'test' or 'train_eval'.""")
tf.app.flags.DEFINE_string('checkpoint_dir', '/data/www/oneten/dl_img_pattern_process2/train_dir/',
...
def eval_once(saver, summary_writer, top_k_op, summary_op, mode):
  ...
  with tf.Session() as sess:
    ...
    try:
      ...
      if mode == 'train':
        log_util.update_job_log(job_code="PATTERN2", accuracy_train=precision, traing_step=int(global_step))
      if mode == 'test':
        log_util.update_job_log(job_code="PATTERN2", accuracy_test=precision, traing_step=int(global_step))
