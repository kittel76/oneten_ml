...
tf.app.flags.DEFINE_string('train_dir', '/data/www/oneten/dl_img_color_process2/train_dir/',
...
def train():
  ...
  log_util.update_job_log(job_code="COLOR2", traing_step=FLAGS.max_steps, batch_size=cifar10.BATCH_SIZE)
