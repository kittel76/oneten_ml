...
tf.app.flags.DEFINE_string('train_directory', '/data/www/oneten/dl_img_color_process2/data_dir/',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', '/data/www/oneten/dl_img_color_process2/data_dir/',
                           'Validation data directory')
tf.app.flags.DEFINE_string('output_directory', '/data/www/oneten/dl_img_color_process2/data_dir',
...
tf.app.flags.DEFINE_string('labels_file', '/data/www/oneten/dl_img_color_process2/data_dir/labels.txt', 'Labels file')
...
def _process_dataset(name, directory, num_shards, labels_file):
  ...
  log_util.update_job_log(job_code="COLOR2", data_cnt=len(filenames))
