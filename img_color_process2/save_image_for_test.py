...
from img_color_process2  import dbJob
from img_color_process2 import common
...
tf.app.flags.DEFINE_string('train_directory', '/data/www/oneten/dl_img_color_process2/test_data_dir/',
                           'Training data directory')
tf.app.flags.DEFINE_string('validation_directory', '/data/www/oneten/dl_img_color_process2/test_data_dir/',
                           'Validation data directory')
tf.app.flags.DEFINE_string('output_directory', '/data/www/oneten/dl_img_color_process2/test_data_dir',
...
tf.app.flags.DEFINE_string('labels_file', '/data/www/oneten/dl_img_color_process2/test_data_dir/labels.txt', 'Labels file')
