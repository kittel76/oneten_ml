...
CHECKPOINT_DIR = '/data/www/oneten/dl_img_detail_process2/train_dir_for_service/'
...
def main(argv=None):  # pylint: disable=unused-argument
  ...
  unique_labels = [l.strip() for l in tf.gfile.FastGFile('/data/www/oneten/dl_img_detail_process2/data_dir/labels.txt', 'r').readlines()]
  dictionary = dict()
