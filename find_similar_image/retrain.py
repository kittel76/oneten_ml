...
def maybe_download_and_extract():
  ...
  if not os.path.exists(filepath):
    ...
    filepath, _ = urllib.urlretrieve(DATA_URL,
                                             filepath,
                                             _progress)
    print()
...
def main(_):
  ...
  print("FLAGS.image_dir", FLAGS.image_dir)
  FLAGS.image_dir = "/data/www/oneten/data_find_similar_image/data_dir"
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/data/www/oneten/data_find_similar_image/train_dir/output_graph.pb',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='/data/www/oneten/data_find_similar_image/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/data/www/oneten/data_find_similar_image/bottleneck',
