...
target_data_dir = "/data/www/oneten/dl_cf_recommend/data_dir/" + args.targetDate
target_train_dir = "/data/www/oneten/dl_cf_recommend/train_dir/" + args.targetDate
...
def svd(train, test, total):
    ...
    with tf.Session(config=config) as sess:
        ...
        print("EPOCH_MAX * samples_per_batch", EPOCH_MAX * samples_per_batch)
        print("samples_per_batch,", samples_per_batch)
        ...
        for i in range(EPOCH_MAX * samples_per_batch):
            ...
            if i % 1000 == 1:
                ...
                print("{} step:{:d} error {:3d} {:f} {:f} {:f}(s)".format(datetime.now(), i, i // samples_per_batch, train_err, test_err, end - start))
